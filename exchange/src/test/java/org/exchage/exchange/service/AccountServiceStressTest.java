...
public class AccountServiceStressTest {
	...
	@Container
	static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16").withDatabaseName("exchange_db")
			.withUsername("test").withPassword("test").waitingFor(Wait.forListeningPort()) // Ensure PostgreSQL is ready
	...
	public void testConnection() {
		// Add a simple assertion to verify that Spring Boot is connecting to the
		// database
